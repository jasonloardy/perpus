...
Public Class CRPeminjaman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpustakaan.CRPeminjaman.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_peminjaman() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRPeminjaman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPeminjaman = New CRPeminjaman()
        rpt.Site = Me.Site
        Return rpt
    End Function
