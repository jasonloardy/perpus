...
Public Class CRPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpustakaan.CRPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kd_pengembalian() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPengembalian = New CRPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
