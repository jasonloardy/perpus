...
Public Class CRLapPengembalian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpustakaan.CRLapPengembalian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLapPengembalian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLapPengembalian = New CRLapPengembalian()
        rpt.Site = Me.Site
        Return rpt
    End Function
